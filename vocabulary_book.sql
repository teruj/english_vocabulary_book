...
(7, 'feudal', 'noun', 'fjúːd', 'of or relating to or characteristic of feudalism', '領地の、封建(制度)の', 'a feudal lord', ' 領主, 大名', 'C', 2),
(8, 'extant', 'adj.', 'ékstənt', 'Still in existence', '今なお残っている、現存の', 'The article is still in existence―still extant.', 'その品は今なお存している', 'S', 2),
(9, 'percolation', 'noun', 'p`ɚːkəléɪʃən', 'The seepage or filtration of a liquid through a porous substance.', '濾過(ろか)、浸透、パーコレーション', 'Generally, sencha is placed in water of around 70 degrees centigrade for one or two minutes for percolation.', '一般に70℃前後のお湯で淹れ、1～2分浸出する。', 'N', 2),
(10, 'astute', 'adj1', 'əst(j)úːt1', 'Quickly and critically discerning.1', '明敏な、機敏な、抜けめのない、ずるい、(…に)抜けめがなくて1', 'He is an astute man.1', '彼は鋭い人間だ。1', 'C', 2),
(11, 'squeamish', 'adj', 'skwíːmɪʃ', 'excessively fastidious and easily disgusted', 'ちょっとしたことでも)ショックを受ける、(道徳的に)潔癖すぎる、気難しい、すぐに吐き気を催す、むかつきやすい', 'so squeamish he would only touch the toilet handle with his elbow', '神経質すぎてひじでトイレのハンドルを触ることしかできない', 'C', 2),
...
(22, 'feudal', 'noun', 'fjúːd', 'of or relating to or characteristic of feudalism', '領地の、封建(制度)の2', 'a feudal lord', ' 領主, 大名', 'S', 2),
...
(33, 'progeny', 'noun', 'prάdʒ(ə)ni', 'offspring; the product of reproduction or replication.', '子孫、(人・動物の)子供たち', 'HAEMATOPOIETIC STEM CELL AND PROGENY THEREOF AND THEIR USE', '造血幹細胞およびその子孫の検出およびその使用', 'N', 2),
(34, 'assuage', 'verb', 'əswéɪdʒ', 'provide physical relief, as from pain', '緩和する、やわらげる、なだめる、静める', 'Nothing could assuage his disappointment.', 'どんなものも彼の失望をやわらげることはできなかった.', 'N', 2),
...
(36, 'sulfur', 'noun', 'sˈʌlfɚ', '(uncountable) A chemical element (symbol S) with an atomic number of 16', '硫黄(いおう)、硫黄色、黄緑色', 'native sulfur', '天然の硫黄', 'C', 2),
(37, 'olfactory', 'adj', 'ɑlfˈæktəri', 'Concerning the sense of smell.', '嗅覚の、嗅官の', 'of or relating to the olfactory cortex of the cerebrum', '大脳の嗅覚皮質の、または、大脳の嗅覚皮質に関する', 'N', 2),
...
(48, 'predominant', 'adj', 'prɪdάmənənt', 'Common or widespread; prevalent.', '(他よりも)優勢な、有力な、卓越した、優勢で、主な、顕著な、目立った', 'Catholicism is the predominant religion in Ireland.', 'アイルランドではカトリックが支配的である.', 'S', 2),
...
(11, 'feudal', 'noun', 'fjúːd', 'of or relating to or characteristic of feudalism', '領地の、封建(制度)の', 'a feudal lord', ' 領主, 大名', 2),
...
(30, 'feudal', 'noun', 'fjúːd', 'of or relating to or characteristic of feudalism1', '領地の、封建(制度)の', 'a feudal lord', ' 領主, 大名', 2),
...
(37, 'astute', 'adj1', 'əst(j)úːt1', 'Quickly and critically discerning.1', '明敏な、機敏な、抜けめのない、ずるい、(…に)抜けめがなくて1', 'He is an astute man.1', '彼は鋭い人間だ。1', 2),
...
(55, 'feudal', 'noun', 'fjúːd', 'of or relating to or characteristic of feudalism', '領地の、封建(制度)の', 'a feudal lord', ' 領主, 大名', 2),
(56, 'phony', 'adj', 'ˈ-fəni', '(informal) A person who assumes an identity or quality other than their own.', 'にせの、いんちきの、うその', 'I got sucked in on a lot of phony deals.', '何回もいかさまにだまされましたよ。', 1),
...
(59, 'adjourn', 'verb', 'ədʒˈɚːn', 'To postpone', '延期する、延会する、(…を)延期する', 'The Diet will adjourn for three month.', '国会は３ヶ月間休会になる。', 2),
(60, 'gape', 'verb', 'géɪp', '(intransitive) To open the mouth wide, especially involuntarily, as in a yawn, anger, or surprise', '(驚いたり感心したりして)ぽかんと大口をあける、(…に)ぽかんと口をあけて見とれる、あくびをする、ぱくりと開く、大きく裂ける、大きく開く', 'gape in public', '人前であくびをする', 1),
